...
export default function PredictionScreen({ userId, platform, subPlatform, onLogout, addToast }: PredictionScreenProps) {
  ...
  const [winners, setWinners] = useState<Winner[]>([
    { id: '1', userId: '5829****21', amount: '+450 EGP', platform: 'paripulse', time: 'Just now' },
    { id: '2', userId: '1029****56', amount: '+12.50$', platform: 'paripulse', time: '1s ago' },
    { id: '3', userId: '9381****10', amount: '+1,500 EGP', platform: 'paripulse', time: '2s ago' },
    { id: '4', userId: '4829****04', amount: '+45.00$', platform: 'paripulse', time: '4s ago' },
    { id: '5', userId: '2019****88', amount: '+750 EGP', platform: 'paripulse', time: '5s ago' }
  ]);
  ...
  useEffect(() => {
    const winnerInterval = setInterval(() => {
      ...
      const newWinner: Winner = {
        ...
        userId: newUserId,
        amount: randomAmount,
        platform: Math.random() > 0.5 ? 'paripulse' : 'megapari',
        time: 'Just now'
      };
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="px-2 py-0.5 rounded-lg text-[8px] font-mono tracking-wide font-black uppercase bg-crimson/15 text-crimson-bright border border-crimson/25">
                      {winner.platform === 'megapari' ? 'Megapari' : 'PariPulse'}
                    </div>
